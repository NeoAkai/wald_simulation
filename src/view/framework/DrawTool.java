...
public class DrawTool {
    ...
    public void drawImage(BufferedImage bI, double x, double y, double width, double height){
        if (graphics2D!= null) graphics2D.drawImage(bI, (int)x, (int)y,(int)width,(int)height, null);
    }
